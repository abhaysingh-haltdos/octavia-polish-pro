...
<div class="min-h-screen bg-[#153758] flex items-center justify-center px-6 py-24">
    <div class="text-center max-w-2xl mx-auto space-y-6">
        ...
        <div>
            <span class="text-8xl sm:text-9xl font-black text-[#C1A972] opacity-30 select-none block leading-none">404</span>
        </div>
        <h1 class="text-3xl sm:text-5xl font-black text-white tracking-tight">Page Not Found</h1>
        <p class="text-[#B4C1CD] text-base sm:text-lg leading-relaxed max-w-lg mx-auto">
            The page you requested could not be located or may have been transitioned to an upgraded service architecture.
        </p>
