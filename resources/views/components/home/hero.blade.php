    ...
    <div class="max-w-6xl mx-auto relative z-10 text-center space-y-8">
        ...
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            >
                ...
                <svg class="w-5 h-5 text-[#C1A972]" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3"></path></svg>
            </button>
            <a
                href="/services"
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 pt-16 max-w-5xl mx-auto text-left">
            <div class="p-5 rounded-2xl bg-white/[0.03] border border-white/10 backdrop-blur-md space-y-2">
                <div class="w-10 h-10 rounded-xl bg-[#C1A972]/20 text-[#C1A972] flex items-center justify-center">
